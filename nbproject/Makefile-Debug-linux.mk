...
${OBJECTDIR}/common/common.o: common/common.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -I/../common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/common.o common/common.cpp

${OBJECTDIR}/common/smx.o: common/smx.cpp
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -I/../common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/smx.o common/smx.cpp

${OBJECTDIR}/common/timloader.o: common/timloader.cpp
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -DDEBUG -I/../common -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/timloader.o common/timloader.cpp
